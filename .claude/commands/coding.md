...
Before completing any task, perform the following verification loop:
1. **Simplification:** Make the code cleaner and more maintainable.
2. **Self-Code Review:**
    - Review the changes against the task requirements.
    - Ensure compliance with DRY, KISS, SOLID.

...
const TYPE_IMAGES = {
  grass:   'https://res.cloudinary.com/dkgfa4apm/image/upload/v1779552239/plante_gwwyja.png',
  poison:  'https://res.cloudinary.com/dkgfa4apm/image/upload/v1779097005/poison_rmllzk.png',
...
function buildEvolutionHtml(tree, currentNumber, megasByNumber = {}, iconByNumber = {}, gigamaxByNumber = {}) {
  ...
  function renderNode(node, depth) {
    ...
    if (node.children.length === 0) {
      ...
      return `<div class="${stageClass}">${portrait}</div>${megaHtml}`;
    }
    ...
    return `<div class="evo-stage">${portrait}</div><div class="evo-branches">${branches}</div>`;
  }

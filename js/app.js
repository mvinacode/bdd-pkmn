...
import { renderGrid, updateCardAfterCatch, setCardCallbacks } from './presentation/card.js?v=7';
import { openModal, closeModal, setModalCallbacks } from './presentation/modal.js?v=225';

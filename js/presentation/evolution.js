...
export function evoArrow(condition = '', itemImageUrl = null, bidirectional = false, isGigamax = false, orientation = 'right') {
  ...
  if (itemImageUrl) {
    ...
    const isItem      = condition && !condition.startsWith('Niv.') && !isNight && !isHappiness && !isRageMove && !isRolloutMove && !isAncientPowerMove && !isCopieMove && !isCoupDoubleMove && !isGalanoaBand && !isCritical;
